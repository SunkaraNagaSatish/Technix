...
const ContactPopup = ({ isOpen, setIsOpen }) => {
    ...
    return (
        <>
            {/* Backdrop */}
            <div
                className={`contact-popup-overlay ${isOpen ? 'contact-popup-overlay-open' : ''}`}
                onClick={handleBackdropClick}
            >
                {/* Popup Modal */}
                <div className={`contact-popup-modal ${isOpen ? 'contact-popup-modal-open' : ''}`}>
                    {/* Close Button */}
                    <button
                    ...
                    <div className="contact-popup-header">
                        ...
                        <p className="contact-popup-subtitle">We'd love to hear from you!</p>
                    </div>
                    ...
                    <div className="contact-popup-content">
                        {/* WhatsApp */}
                        <a
                            href="https://wa.me/919381736309"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="contact-popup-item whatsapp"
                        >
                            <div className="contact-popup-icon whatsapp-bg">
                        ...
                        {/* Phone Call */}
                        <a
                            href="tel:+919381736309"
                            className="contact-popup-item phone"
                        >
                            <div className="contact-popup-icon phone-bg">
