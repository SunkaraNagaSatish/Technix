    ...
    feature_data: [
        {
            ...
            img: feature_img_1,
            title: "Who We Are",
            description: <>Dedicated IT staffing & technology services partner.</>,
                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-lg-6">
                            <div className="tp-feature-wrapper p-relative">
                                <p>We combine technical excellence, structured execution, <br />
                                    and client-first thinking to help organizations innovate faster.</p>
                            </div>
                        </div>
                    </div>
